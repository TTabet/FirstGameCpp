...
void AItemBase::OverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult & SweepResult)
{
	if(Cast<ASpherePlayer>(OtherActor) != nullptr)
	{
		Collected();
	}
}
...
void AItemBase::Collected_Implementation()
{
	...
	AFirstCppGameModeBase* GameMode = Cast<AFirstCppGameModeBase>(GetWorld()->GetAuthGameMode());
	if(GameMode)
	{
